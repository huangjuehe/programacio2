...
public class Camping implements InCamping, Serializable {
    ...
    public String llistarAccessos(String infoEstat) throws ExcepcioCamping {
        boolean estatBuscant = infoEstat.equalsIgnoreCase("Obert") || infoEstat.equalsIgnoreCase("Oberts");
        return this.llistaAccessos.llistarAccessos(estatBuscant);
    }
    ...
    public void afegirTascaManteniment(int num, String tipus, String idAllotjament, String data, int dies) throws ExcepcioCamping {
        Allotjament a = this.llistaAllotjaments.getAllotjament(idAllotjament);
        this.llistaTasquesManteniment.afegirTascaManteniment(num, tipus, a, data, dies);
        this.llistaAccessos.actualitzaEstatAccessos(); // S'actualitzen les carreteres en tancar un allotjament
    }
    ...
    public void save(String camiDesti) throws ExcepcioCamping {
        try {
            ...
            throw new ExcepcioCamping("Error guardant les dades: " + e.getMessage());
        }
    }
    ...
    public static Camping load(String camiOrigen) throws ExcepcioCamping {
        try {
            ...
            throw new ExcepcioCamping("Error carregant les dades: " + e.getMessage());
        }
    }
    ...
    public void inicialitzaDadesCamping() {
        ...
        try {
            ...
            // Error controlat durant la inicialització (tot i que les dades per defecte són vàlides)
        }
    }
}